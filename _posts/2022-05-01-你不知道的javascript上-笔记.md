...
这段代码的核心是 `Bar.prototype = Object.create(Foo.prototype)`, 调用`Object.create(...)`会凭空创建一个新对象, 并把新对象内部的`[[Prototype]]`关联到你指定的对象, 换句话说, 这条语句的意思就是 **创建一个新的 Bar.prototype 对象, 并把它关联到 Foo.prototype**。
